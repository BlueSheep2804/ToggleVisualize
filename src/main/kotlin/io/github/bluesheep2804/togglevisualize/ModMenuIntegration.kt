                    ...
                    .category(ConfigCategory.createBuilder()
                            ...
                            .group(OptionGroup.createBuilder()
                                    ...
                                    .option(Option.createBuilder<Boolean>()
                                            ...
                                            .binding(defaultConfig.sprintShow, { config.sprintShow }, {newVal -> config.sprintShow = newVal})
                            ...
                            .group(OptionGroup.createBuilder()
                                    ...
                                    .option(Option.createBuilder<Boolean>()
                                            .name(Component.literal("Indicator"))
                                            .binding(defaultConfig.crouchShow, { config.crouchShow }, {newVal -> config.crouchShow = newVal})
                                            .controller(TickBoxControllerBuilder::create)
                                            .build())
                                    .option(Option.createBuilder<Int>()
                                            .name(Component.literal("Indicator position X"))
